import { Archive, ArrowLeft, Copy, Eye, Link2, Pencil, RotateCcw, SlidersHorizontal, Trash2, X } from "lucide-react";
...
function templateFeedback(value: string | undefined): string | null { if (value === "created") return "Bronprofielsjabloon gemaakt."; if (value === "updated") return "Bronprofielsjabloon bijgewerkt."; if (value === "duplicated") return "Bronprofielsjabloon onafhankelijk gedupliceerd."; if (value === "default") return "Standaardsjabloon gewijzigd voor toekomstige leeromgevingen."; if (value === "archived") return "Bronprofielsjabloon gearchiveerd."; if (value === "restored") return "Bronprofielsjabloon hersteld."; if (value === "deleted") return "Bronprofielsjabloon permanent verwijderd."; return null; }
