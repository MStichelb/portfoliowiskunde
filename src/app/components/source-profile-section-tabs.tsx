...
export function SourceProfileSectionTabs({ ownedSection, editorSection, templateSection, initialTab = "owned" }: {
  ...
  return <>
    <div className="source-profile-section-tabs" role="tablist" aria-label="Bronprofieloverzicht">
      ...
      <button id={`${baseId}-editor-tab`} aria-controls={`${baseId}-editor-panel`} type="button" role="tab" aria-selected={tab === "editor"} className={tab === "editor" ? "is-active" : ""} onClick={() => setTab("editor")}>Bronprofielen uit leeromgevingen</button>
