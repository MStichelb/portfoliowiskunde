...
Vanuit het ingebouwde profiel kan een owner of superadmin een eigen profiel maken. Een actief profiel uit een toegestane managementcontext kan ook worden gekopieerd. Zo'n kopie krijgt een nieuwe identiteit, een eigen managementcontext en een gevalideerde snapshot van de configuratie: latere wijzigingen lopen in geen van beide richtingen door. In de LearningSpace-flow activeren owner en superadmin hun kopie; een editor-kopie en elke kopie vanuit het centrale overzicht blijven inactief. Alleen owners en superadmins kunnen de naam van een bestaand custom profiel wijzigen.

De scanner leest deze configuratie in B3.3.1 nog niet: profiel-, template-, default- en kopieeracties starten geen synchronisatie en sync en indexering blijven exact de bestaande implementatie gebruiken. Latere fases voegen terminologie, resources en scannerregels toe zonder het interne portfolio-domein of de read-only bronprincipes te wijzigen.
