...
3. Maak optioneel een bestand `.env.local` met onderstaande variabele. Zonder variabele gebruikt de app de huidige lokale testmap.
...
5. Open `http://localhost:3000/admin` en kies **Opnieuw synchroniseren**.
