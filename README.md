...
Elke LearningSpace is gekoppeld aan precies één concreet [bronprofiel](./docs/source-profiles.md). Nieuwe LearningSpaces krijgen een onafhankelijke snapshot van het actuele appbrede standaardsjabloon; het ingebouwde profiel is alleen een technische fallback. Kopiëren maakt altijd een nieuw, onafhankelijk concreet profiel: voor een owner of superadmin wordt dat profiel meteen actief in de doel-LearningSpace, terwijl een editor-kopie inactief blijft tot een eigenaar ze activeert. Owners en superadmins kunnen daarnaast een bestaand concreet profiel rechtstreeks koppelen, zodat meerdere LearningSpaces exact hetzelfde profiel delen. Templates kunnen nooit rechtstreeks gekoppeld worden. Alleen superadmins muteren templates en het standaardsjabloon. De huidige scanner blijft ongewijzigd en gebruikt deze profielconfiguratie nog niet.
