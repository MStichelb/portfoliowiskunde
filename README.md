...
Elke LearningSpace is gekoppeld aan precies één concreet [bronprofiel](./docs/source-profiles.md). Nieuwe LearningSpaces krijgen een onafhankelijke snapshot van het actuele appbrede standaardsjabloon; het ingebouwde profiel is alleen een technische fallback. Gewone profiel- en centrale templatekopieën blijven inactief; activeren gebeurt apart via de profielkeuze, behalve bij de expliciete LearningSpace-actie **Kopiëren en activeren**. Owners en superadmins beheren de actieve koppeling, terwijl editors bestaande configuratie alleen bekijken en onafhankelijke kopieën mogen maken. Alleen superadmins muteren templates en het standaardsjabloon. De huidige scanner blijft in B3.3.2 ongewijzigd.
