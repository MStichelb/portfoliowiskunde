...
Elke LearningSpace is gekoppeld aan precies één concreet [bronprofiel](./docs/source-profiles.md). Nieuwe LearningSpaces krijgen een onafhankelijke snapshot van het actuele appbrede standaardsjabloon; het ingebouwde profiel is alleen een technische fallback. Beheerders zien concrete profielen en hun actuele gebruik centraal via **Bronprofielen**; superadmins beheren daar afzonderlijk de appbrede sjablonen en het standaardsjabloon. De huidige scanner blijft in B3.3 ongewijzigd.
