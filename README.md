...
Elke LearningSpace is gekoppeld aan precies één concreet [bronprofiel](./docs/source-profiles.md). Nieuwe LearningSpaces krijgen een onafhankelijke snapshot van het actuele appbrede standaardsjabloon; het ingebouwde profiel is alleen een technische fallback. Owners en superadmins beheren de actieve koppeling, terwijl editors bestaande configuratie alleen bekijken en onafhankelijke, niet-actieve kopieën mogen maken. Appbrede sjablonen zijn voor actieve leraren leesbare kopieerbronnen, worden altijd eerst concrete snapshots en zijn nooit rechtstreeks actief; alleen superadmins muteren templates en het standaardsjabloon. De huidige scanner blijft in B3.3.1 ongewijzigd.
